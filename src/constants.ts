// Since this version, the Dharitri Ledger App only supports signing a hash of the transaction - tx.options = 0b0001.
export const LEDGER_TX_HASH_SIGN_MIN_VERSION = "1.0.11";

// Since this version, the Dharitri Ledger App supports guarded transactions - tx.options = 0b00(0|1)1.
